...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "StandardCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	...
	{"seed6.cryptolife.net", "seed6.cryptolife.net"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. StandardCoin is probably already running."), addrBind.ToString().c_str());
        else
